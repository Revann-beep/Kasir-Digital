  ...
  // Variabel untuk uang yang dibayar dan kembalian
  $uang_dibayar = isset($_POST['uang_dibayar']) ? floatval($_POST['uang_dibayar']) : 0;
  $kembalian = ($uang_dibayar > 0) ? $uang_dibayar - $transaksi['total_harga'] : 0;
  ...
  <!-- Tabel Pembayaran dan Pengembalian -->
  <h3>Pembayaran</h3>
  <table>
    <tr>
      <td><label for="uang_dibayar">Uang Dibayar</label></td>
      <td><input type="number" name="uang_dibayar" value="<?= $uang_dibayar ?>" min="0" step="1000" required></td>
    </tr>
    <tr>
      <td><strong>Kembalian: </strong></td>
      <td><span>Rp<?= number_format($kembalian, 0, ',', '.') ?></span></td>
    </tr>
    <tr>
